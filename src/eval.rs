...
use crate::{NixOption, OptionType, OptionValue};
...
pub fn demo_options() -> Vec<NixOption> {
    vec![
        ...
        NixOption {
            ...
            example: Some(OptionValue::Bool(true)),
            declared: true,
        ...
        NixOption {
            ...
            default: Some(OptionValue::Str("nodev".into())),
            example: Some(OptionValue::Str("/dev/sda".into())),
            declared: true,
            declared_in: Some("nixos/modules/system/boot/loader/grub/grub.nix".into()),
        },
        NixOption {
        ...
        NixOption {
            ...
            option_type: OptionType::Package,
            default: Some(OptionValue::Str("pkgs.linuxPackages".into())),
            example: Some(OptionValue::Str("pkgs.linuxPackages_latest".into())),
            declared: true,
            declared_in: None,
        },
        // networking
        NixOption {
            ...
            example: Some(OptionValue::Str("myhostname".into())),
            declared: true,
        ...
        NixOption {
            ...
            option_type: OptionType::List { element: Box::new(OptionType::Int { min: Some(1), max: Some(65535) }) },
            default: Some(OptionValue::List(vec![])),
            example: Some(OptionValue::List(vec![OptionValue::Int(22), OptionValue::Int(80), OptionValue::Int(443)])),
            declared: true,
            declared_in: None,
        },
        // services
        ...
        NixOption {
            ...
            default: Some(OptionValue::Str("prohibit-password".into())),
            example: Some(OptionValue::Str("no".into())),
            declared: true,
            declared_in: Some("nixos/modules/services/networking/ssh/sshd.nix".into()),
        },
        NixOption {
            ...
            option_type: OptionType::List { element: Box::new(OptionType::Int { min: Some(1), max: Some(65535) }) },
            default: Some(OptionValue::List(vec![OptionValue::Int(22)])),
            example: None,
            declared: true,
            declared_in: None,
        },
        ...
        NixOption {
            ...
            option_type: OptionType::List { element: Box::new(OptionType::Package) },
            default: Some(OptionValue::List(vec![])),
            example: Some(OptionValue::List(vec![
                OptionValue::Str("pkgs.wget".into()),
                OptionValue::Str("pkgs.vim".into()),
            ])),
            declared: true,
            declared_in: None,
        },
        ...
        NixOption {
            ...
            option_type: OptionType::Nullable { inner: Box::new(OptionType::Str) },
            default: Some(OptionValue::Null),
            example: Some(OptionValue::Str("America/New_York".into())),
            declared: true,
            declared_in: None,
        },
        // i18n
        NixOption {
            ...
            option_type: OptionType::Str,
            default: Some(OptionValue::Str("en_US.UTF-8".into())),
            example: Some(OptionValue::Str("nl_NL.UTF-8".into())),
            declared: true,
            declared_in: None,
        },
        // nix
        NixOption {
            ...
            option_type: OptionType::List { element: Box::new(OptionType::Str) },
            default: Some(OptionValue::List(vec![])),
            example: Some(OptionValue::List(vec![OptionValue::Str("nix-command".into()), OptionValue::Str("flakes".into())])),
            declared: true,
            declared_in: None,
        },
        NixOption {
        ...
        NixOption {
            ...
            option_type: OptionType::Str,
            default: Some(OptionValue::Str("weekly".into())),
            example: Some(OptionValue::Str("03:15".into())),
            declared: true,
            declared_in: None,
        },
    ]
